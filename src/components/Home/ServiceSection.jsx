...
const services = [
  {
    ...
    desc: `Premium tinting for privacy, UV protection, and cooler interiors.`,
    image: "/carpaint.avif",
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
              <div
                key={index}
                className="relative min-w-[300px] md:min-w-[400px] h-[520px] rounded-lg shadow-lg border-[#da2912]
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[95%] mt-15 h-55 mx-auto object-cover"
                    onError={(e) => {
